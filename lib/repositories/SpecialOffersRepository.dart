...
class SpecialOffersRepository {
  ...
  void _fillList() {
    _list.add(new Burger(
        4.15,
        "Double X Bacon",
        "https://www.minervafoods.com/wp-content/uploads/2021/01/imagem-produtos.jpg",
        new List(),
        new List()));
    _list.add(new Burger(
        6.25,
    ...
    _list.add(new Burger(
        7.0,
        "Monster Chill",
        "https://www.integracaodaserra.com.br/wp-content/uploads/2018/05/shutterstock_361890473-1030x596.jpg",
        new List(),
        new List()));
    _list.add(new Burger(
        2.15,
